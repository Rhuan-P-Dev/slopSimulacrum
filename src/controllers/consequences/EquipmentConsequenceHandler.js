/**
 * EquipmentConsequenceHandler — Handles equipment grab and release operations.
 * Single Responsibility: Manage all equipment-related consequence execution (hand grabs, backpack items).
 *
