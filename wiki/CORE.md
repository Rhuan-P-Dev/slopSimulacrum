...
- [Group Pick](subMDs/frontend/group_pickup.md) — Cluster pickup window: per-type stacks with quantity steppers, triggered by the data-driven `pickUpItem.groupPick` config
