...
describe('readCharaCard', () => {
    // The real card PNG is gitignored (data/cards/*) — this test only runs in
    // environments where the file actually exists (it reads the real payload).
    it.skipIf(!fs.existsSync(FRISK_PNG))('extracts the embedded nested payload from the real Frisk PNG', () => {
